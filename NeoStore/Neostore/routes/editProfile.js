      ...
      <ScrollView>
        ...
        <View
          ...
          <View style={{width: '77%', marginBottom: 25, maxWidth: 450}}>
            <TextInput style={styles.input} value={'Nilesh'} />
            <TextInput style={styles.input} value={'Chavan'} />

            <TextInput style={styles.input} value={'nileshchavan@gmail.com'} />
            <TextInput style={styles.input} value={'8451834334'} />
